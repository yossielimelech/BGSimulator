...
namespace BGSimulator.Model
{
    public class Pool
    {
        ...
        private void Initialize()
        {
            ...
            {
                //Tier 1
                new MinionBase() { MinionType = MinionType.Beast, Name = "Alleycat", Attack = 1, Health = 1, MinionTier = MinionTier.Ranks[1], Tags = MinionTag.BattleCry, OnPlayed = (tp) =>  { tp.Board.Summon("Tabbycat",tp.Index, golden: tp.Activator.Level == 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Mecharoo", Attack = 1, Health = 1, Attributes = Attribute.DeathRattle, MinionTier = MinionTier.Ranks[1], OnDeath = (tp) =>  { tp.Board.Summon("Jo-E Bot",tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Murloc, Name = "Murloc Tidehunter", Cost = 2, Attack = 2, Health = 1, MinionTier = MinionTier.Ranks[1], Tags = MinionTag.BattleCry, OnPlayed = (tp) =>  { tp.Board.Summon("Murloc Scout",tp.Index, golden: tp.Activator.Level == 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Demon, Name = "Vulgar Homunculus", Cost = 2, Attack = 2,Health = 4 , MinionTier = MinionTier.Ranks[1], Attributes = Attribute.Taunt, Tags = MinionTag.BattleCry, OnPlayed = (tp) => { tp.Player.TakeDamage(2 * tp.Activator.Level); } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Harvest Golem", Cost = 3, Attack = 2, Health = 3, MinionTier = MinionTier.Ranks[2], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { tp.Board.Summon("Damaged Golem", tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Beast, Name = "Rat Pack", Cost = 3, Attack = 2, Health = 2, MinionTier = MinionTier.Ranks[2], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { tp.Board.Summon("Rat", tp.Index, Direction.InPlace, tp.Activator.Attack, golden: tp.Activator.Level == 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Demon, Name = "Floating Watcher", Cost = 5, Attack = 4, Health = 4 , MinionTier = MinionTier.Ranks[3], OnPlayerDamage = (tp) => { tp.Board.Buff(tp.Activator,tp.Activator,2 ,2); } }, // on player damage
                ...
                new MinionBase() { MinionType = MinionType.Beast, Name = "Infested Wolf", Cost = 4, Attack = 3, Health = 3, MinionTier = MinionTier.Ranks[3], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { tp.Board.Summon("Spider", tp.Index, Direction.InPlace, 2, golden: tp.Activator.Level == 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Piloted Shredder", Cost = 4, Attack = 4, Health = 3, MinionTier = MinionTier.Ranks[3], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0; i < tp.Activator.Level; i++) { tp.Board.Summon(GetRandomMinions(m => m.Cost == 2 && m.PoolMinion), tp.Index, Direction.InPlace ); } } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Mechano-Egg", Cost = 5, Attack = 0, Health = 5, MinionTier = MinionTier.Ranks[4], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { tp.Board.Summon("Robosaur", tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Murloc, Name = "Primalfin Lookout", Cost = 3, Attack = 3, Health = 2, MinionTier = MinionTier.Ranks[5], Tags = MinionTag.BattleCry, OnPlayed = (tp) => { for(int i = 0; i < tp.Activator.Level; i++) { if(!tp.Board.Controls(MinionType.Murloc, tp.Activator)) return; tp.Player.ChooseDiscover(Discover((m) => m.MinionType == MinionType.Murloc && m.Name != tp.Activator.Name)); } } },

                new MinionBase() { MinionType = MinionType.Beast, Name = "Sated Threshadon", Cost = 7, Attack = 5, Health = 7, MinionTier = MinionTier.Ranks[5], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { tp.Board.Summon("Primalfin", tp.Index, Direction.InPlace, 3, golden: tp.Activator.Level == 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Beast, Name = "Savannah Highmane", Cost = 6, Attack = 6, Health = 5, MinionTier = MinionTier.Ranks[5], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { tp.Board.Summon("Hyena", tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Demon, Name = "Voidlord", Cost = 9, Attack = 3,Health =9 , MinionTier = MinionTier.Ranks[5], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { tp.Board.Summon("Voidwalker", tp.Index, Direction.InPlace, 3, golden: tp.Activator.Level == 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Neutral, Name = "Kangor's Apprentice", Cost = 9, Attack = 3, Health = 6, MinionTier = MinionTier.Ranks[6], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { tp.Board.SummonFromGraveyard(MinionType.Mech, tp.Index, amount: 2 * tp.Activator.Level); } },
