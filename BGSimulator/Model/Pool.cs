...
namespace BGSimulator.Model
{
    public class Pool
    {
        ...
        private void Initialize()
        {
            ...
            {
                //Tier 1
                new MinionBase() { MinionType = MinionType.Beast, Name = "Alleycat", Attack = 1, Health = 1, MinionTier = MinionTier.Ranks[1], Tags = MinionTag.BattleCry, OnPlayed = (tp) =>  {   for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Tabbycat",tp.Index, golden: tp.Activator.Level == 2); } }  },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Mecharoo", Attack = 1, Health = 1, Attributes = Attribute.DeathRattle, MinionTier = MinionTier.Ranks[1], OnDeath = (tp) =>  {   for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Jo-E Bot",tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } } },
                ...
                new MinionBase() { MinionType = MinionType.Murloc, Name = "Murloc Tidehunter", Cost = 2, Attack = 2, Health = 1, MinionTier = MinionTier.Ranks[1], Tags = MinionTag.BattleCry, OnPlayed = (tp) =>  {   for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Murloc Scout",tp.Index, golden: tp.Activator.Level == 2); } } },
                ...
                new MinionBase() { MinionType = MinionType.Neutral, Name = "Selfless Hero", Attack = 2, Health = 1, MinionTier = MinionTier.Ranks[1], OnDeath = (tp) => { tp.Board.BuffRandom(tp.Activator, attributes: Attribute.DivineShield); } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Harvest Golem", Cost = 3, Attack = 2, Health = 3, MinionTier = MinionTier.Ranks[2], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Damaged Golem", tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } } },
                ...
                new MinionBase() { MinionType = MinionType.Beast, Name = "Kindly Grandmother", Cost = 2, Attack = 1, Health = 1, MinionTier = MinionTier.Ranks[2], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Big Bad Wolf", tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Metaltooth Leaper", Cost = 3, Attack = 3, Health = 3, MinionTier = MinionTier.Ranks[2], Tags = MinionTag.BattleCry, OnPlayed = (tp) => { tp.Board.BuffAllOfType(tp.Activator, MinionType.Mech, 2); } },

                new MinionBase() { MinionType = MinionType.Beast, Name = "Mounted Raptor", Cost = 3, Attack = 3, Health = 2, MinionTier = MinionTier.Ranks[2], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon(GetRandomMinions(m => m.Cost == 1 && m.PoolMinion), tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } } },

                new MinionBase() { MinionType = MinionType.Murloc, Name = "Murloc Warleader", Cost = 3, Attack = 3, Health = 3, MinionTier = MinionTier.Ranks[2],  }, // ****

                new MinionBase() { MinionType = MinionType.Demon, Name = "Nathrezim Overseer", Cost = 3, Attack = 2,Health = 4 , MinionTier = MinionTier.Ranks[2], Tags = MinionTag.Targeted | MinionTag.BattleCry, ValidTargets = MinionType.Demon, OnPlayed = (tp) => { if(tp.Target ==null) return; tp.Board.Buff(tp.Activator, tp.Target,2,2); } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Pogo-Hopper", Cost = 1, Attack = 1, Health = 1, MinionTier = MinionTier.Ranks[2], OnPlayed = (tp) => { var count = tp.Player.MinionsPlayedThisGame.Where(m => m == tp.Activator.Name).Count() - 1; tp.Board.Buff(tp.Activator, tp.Activator, count * 2,count * 2); } },

                new MinionBase() { MinionType = MinionType.Beast, Name = "Rat Pack", Cost = 3, Attack = 2, Health = 2, MinionTier = MinionTier.Ranks[2], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Rat", tp.Index, Direction.InPlace, tp.Activator.Attack, golden: tp.Activator.Level == 2); } } },
                ...
                new MinionBase() { MinionType = MinionType.Neutral, Name = "Spawn of N'Zoth", Cost = 3, Attack = 2, Health = 2, MinionTier = MinionTier.Ranks[2], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { tp.Board.BuffAllOfType(tp.Activator, MinionType.All, 1, 1); } },

                new MinionBase() { MinionType = MinionType.Mech, Name = "Zoobot", Cost = 3, Attack = 3, Health = 3, MinionTier = MinionTier.Ranks[2], Tags = MinionTag.BattleCry, OnPlayed = (tp) => { tp.Board.BuffRandomUnique(tp.Activator, new List<MinionType>(){ MinionType.Murloc, MinionType.Beast, MinionType.Dragon }, 1, 1); } },
                ...
                new MinionBase() { MinionType = MinionType.Murloc, Name = "Coldlight Seer", Cost = 3, Attack = 2, Health = 3, MinionTier = MinionTier.Ranks[3], Tags = MinionTag.BattleCry, ValidTargets = MinionType.Murloc, OnPlayed = (tp) => { tp.Board.BuffAllOfType(tp.Activator, type:tp.Activator.ValidTargets, health: 2); } },

                new MinionBase() { MinionType = MinionType.Neutral, Name = "Crowd Favorite", Cost = 4, Attack = 4, Health = 4, MinionTier = MinionTier.Ranks[3], OnMinionSummon = (tp) => { if(tp.Summon == null || !tp.Summon.Tags.HasFlag(MinionTag.BattleCry)) return; tp.Board.Buff(tp.Activator, tp.Activator, 1, 1); } },

                new MinionBase() { MinionType = MinionType.Neutral, Name = "Crystalweaver", Cost = 4, Attack = 5, Health = 4, MinionTier = MinionTier.Ranks[3], Tags = MinionTag.Targeted | MinionTag.BattleCry, ValidTargets = MinionType.Demon, OnPlayed = (tp) => { if(tp.Target == null) return; tp.Board.Buff(tp.Activator, tp.Target, 1, 1); } },
                ...
                new MinionBase() { MinionType = MinionType.Neutral, Name = "Houndmaster", Cost = 4, Attack = 4, Health = 3, MinionTier = MinionTier.Ranks[3], Tags = MinionTag.Targeted | MinionTag.BattleCry, ValidTargets = MinionType.Beast, OnPlayed = (tp) => { if(tp.Target == null) return; tp.Board.Buff(tp.Activator, tp.Target, 2, 2); } },

                new MinionBase() { MinionType = MinionType.Demon, Name = "Imp Gang Boss", Cost = 3, Attack = 2, Health = 4 , MinionTier = MinionTier.Ranks[3], OnDamage = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Imp", tp.Index, golden: tp.Activator.Level == 2); } } },

                new MinionBase() { MinionType = MinionType.Demon, Name = "Imp", Attack = 1, Health = 1 , MinionTier = MinionTier.Ranks[1], PoolMinion = false },

                new MinionBase() { MinionType = MinionType.Beast, Name = "Infested Wolf", Cost = 4, Attack = 3, Health = 3, MinionTier = MinionTier.Ranks[3], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Spider", tp.Index, Direction.InPlace, 2, golden: tp.Activator.Level == 2); } } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Piloted Shredder", Cost = 4, Attack = 4, Health = 3, MinionTier = MinionTier.Ranks[3], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon(GetRandomMinions(m => m.Cost == 2 && m.PoolMinion), tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Screwjank Clunker", Cost = 4, Attack = 2, Health = 5, MinionTier = MinionTier.Ranks[3], Tags = MinionTag.Targeted | MinionTag.BattleCry, ValidTargets = MinionType.Mech, OnPlayed = (tp) => { if(tp.Target == null) return; tp.Board.Buff(tp.Activator, tp.Target, 2, 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Neutral, Name = "Soul Juggler", Cost = -1, Attack = 3, Health = 3, MinionTier = MinionTier.Ranks[3], OnMinionDied = (tp) => { if(tp.Target.MinionType != MinionType.Demon) return; var target = tp.RivalBoard.GetRandomMinion(); if(target == null) return;  tp.RivalBoard.ShootMinion(target, 3, tp.Board); } },
                ...
                new MinionBase() { MinionType = MinionType.Neutral, Name = "Tortollan Shellraiser", Cost = 4, Attack = 2, Health = 6, MinionTier = MinionTier.Ranks[3], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { tp.Board.BuffRandom(tp.Activator, 1, 1); } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Mechano-Egg", Cost = 5, Attack = 0, Health = 5, MinionTier = MinionTier.Ranks[4], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Robosaur", tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } } },

                new MinionBase() { MinionType = MinionType.Neutral, Name = "Menagerie Magician", Cost = 5, Attack = 4, Health = 4, MinionTier = MinionTier.Ranks[4], Tags = MinionTag.Targeted | MinionTag.BattleCry, OnPlayed = (tp) => { tp.Board.BuffRandomUnique(tp.Activator, new List<MinionType>(){ MinionType.Beast, MinionType.Dragon, MinionType.Murloc }, 2, 2); } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Security Rover", Cost = 6, Attack = 2, Health = 6, MinionTier = MinionTier.Ranks[4], OnDamage = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Guard Bot", tp.Index, golden: tp.Activator.Level == 2); } } },
                ...
                new MinionBase() { MinionType = MinionType.Murloc, Name = "Toxfin", Cost = 1, Attack = 1, Health = 2, MinionTier = MinionTier.Ranks[4] , Tags = MinionTag.Targeted | MinionTag.BattleCry, ValidTargets = MinionType.Murloc, OnPlayed = (tp) => { if(tp.Target ==null) return; tp.Board.Buff(tp.Activator, tp.Target, attributes: Attribute.Poison); } },

                new MinionBase() { MinionType = MinionType.Neutral, Name = "Virmen Sensei", Cost = 5, Attack = 4, Health = 5, MinionTier = MinionTier.Ranks[4], Tags = MinionTag.Targeted | MinionTag.BattleCry, ValidTargets = MinionType.Beast, OnPlayed = (tp) => { if(tp.Target ==null) return; tp.Board.Buff(tp.Activator, tp.Target, 2 , 2); } },

                ////Tier 5
                new MinionBase() { MinionType = MinionType.Demon, Name = "Annihilan Battlemaster", Cost = 8, Attack = 3, Health = 1 , MinionTier = MinionTier.Ranks[5], Tags = MinionTag.BattleCry, OnPlayed = (tp) => { tp.Board.Buff(tp.Activator, tp.Activator, 0, tp.Player.MissingHealth); } },
                ...
                new MinionBase() { MinionType = MinionType.Beast, Name = "Sated Threshadon", Cost = 7, Attack = 5, Health = 7, MinionTier = MinionTier.Ranks[5], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Primalfin", tp.Index, Direction.InPlace, 3, golden: tp.Activator.Level == 2); } } },
                ...
                new MinionBase() { MinionType = MinionType.Beast, Name = "Savannah Highmane", Cost = 6, Attack = 6, Health = 5, MinionTier = MinionTier.Ranks[5], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Hyena", tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } } },

                new MinionBase() { MinionType = MinionType.Beast, Name = "Hyena", Attack = 2, Health = 2, MinionTier = MinionTier.Ranks[1], PoolMinion = false },

                new MinionBase() { MinionType = MinionType.Neutral, Name = "Strongshell Scavenger", Cost = 4, Attack = 2, Health = 3, MinionTier = MinionTier.Ranks[5], Tags = MinionTag.BattleCry, OnPlayed = (tp) => { tp.Board.BuffAllWithAttribute(tp.Activator, Attribute.Taunt, 2, 2); } },

                new MinionBase() { MinionType = MinionType.Demon, Name = "Voidlord", Cost = 9, Attack = 3,Health =9 , MinionTier = MinionTier.Ranks[5], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon("Voidwalker", tp.Index, Direction.InPlace, 3, golden: tp.Activator.Level == 2); } } },
                ...
                new MinionBase() { MinionType = MinionType.Mech, Name = "Sneed's Old Shredder", Cost = 8, Rarity = Rarity.Legendary, Attack = 5, Health = 7, MinionTier = MinionTier.Ranks[6], Attributes = Attribute.DeathRattle, OnDeath = (tp) => { for(int i = 0;i < tp.Activator.Level;i++) { tp.Board.Summon(GetRandomMinions(m => m.Rarity == Rarity.Legendary && m.Name != tp.Activator.Name).First().Name, tp.Index, Direction.InPlace, golden: tp.Activator.Level == 2); } } },
